## Compression-Interleaved Parenthesization Defects in LLM Replay Artifact Graphs
...
summaries were negative; that complete-family direction is reported
descriptively only because no reverse-direction hypothesis was predeclared.

The release includes the manuscript, TeX source, frozen protocol, descriptive
reporting addendum, exact runner and summarizer snapshots, case manifest,
