...
This line cannot move much faster without dedicated time and compute. The main open question is not whether the primitive is coherent—the formalization and implementation are in place—but whether it generalizes. That is a validation and scaling problem, and that is what this grant would fund.
