...
- `06` through `178` are the tracked Gate6-Gate11 line, kept in numeric order
...
- the latest tracked Gate11 handoff is `178`
- no later spec-only Gate11 slice is currently tracked
