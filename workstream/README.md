...
- `06` through `181` are the tracked Gate6-Gate11 line, kept in numeric order
...
- the latest tracked Gate11 handoff is `180`
- the current in-worktree Gate11 snapshot extends through `182`
- the next tracked spec-only Gate11 slice is `181`
