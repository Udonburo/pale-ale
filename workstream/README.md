...
- `06` through `146` are the tracked Gate6-Gate11 line, kept in numeric order
...
- the latest tracked Gate11 handoff is `146`
- no next spec-only Gate11 slice is tracked yet
