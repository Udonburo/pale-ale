...
class Gate12ATriangleReadingPacketTest(unittest.TestCase):
    ...
    def test_run_triangle_reading_packet_can_balance_high_and_flat(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            root = Path(tmpdir)
            queue_dir = self._build_balanced_queue_fixture(root)
            text_audit_dir = self._build_balanced_text_audit_fixture(root)
            out_dir = root / "reading_packet_balanced"
    ...
    def _build_balanced_queue_fixture(self, root: Path) -> Path:
        queue_dir = root / "queue_balanced"
        write_json(queue_dir / "manifest.json", {"run_id": "queue_fixture", "code_git_commit": "fixture-commit"})
        write_csv(
            queue_dir / "triangle_reading_queue.csv",
            [
            ...
            [
                {
                    "queue_rank": "1",
                    "cycle_id": "triangle:101",
                    "sample_id": "sample_high_1",
                    "provisional_closure_band": "high_tension",
                ...
                {
                    "queue_rank": "2",
                    "cycle_id": "triangle:102",
                    "sample_id": "sample_high_2",
                    "provisional_closure_band": "high_tension",
                    "holonomy_residual_fro": "1.9",
                    "residual_percentile": "0.9",
                    "prompt_path": "p2",
                    "answer_path": "a2",
                    "support_anchor_path": "",
                    "conflict_anchor_path": "",
                ...
                {
                    "queue_rank": "3",
                    "cycle_id": "triangle:103",
                    "sample_id": "sample_flat_1",
                    "provisional_closure_band": "flat",
                    "holonomy_residual_fro": "0.1",
                    "residual_percentile": "0.0",
                    "prompt_path": "p3",
                ...
                {
                    "queue_rank": "4",
                    "cycle_id": "triangle:104",
                    "sample_id": "sample_flat_2",
                    "provisional_closure_band": "flat",
                    "holonomy_residual_fro": "0.2",
    ...
    def _build_balanced_text_audit_fixture(self, root: Path) -> Path:
        audit_dir = root / "text_audit_balanced"
        write_json(audit_dir / "manifest.json", {"run_id": "text_audit_fixture", "code_git_commit": "fixture-commit"})
        write_jsonl(
            audit_dir / "triangle_text_surface_joined.jsonl",
            [
                {
                    ...
                    "anchor_qualified_path": [True, True, False],
                    "relation_kind_path": ["trusted_tree", "trusted_tree", "residual_chord"],
                    "compatibility_gap_path_summary": {"min": 0.9, "median": 1.0, "max": 1.1, "mean": 1.0},
                    "prompt_text": "Prompt high 1",
                    "answer_text": "Answer high 1",
                    "support_anchor_text": "",
                    "conflict_anchor_text": "",
                },
                {
                    "cycle_id": "triangle:102",
                    "edge_id_path": ["e4", "e5", "e6"],
                    ...
                    "relation_kind_path": ["trusted_tree", "trusted_tree", "residual_chord"],
                    "compatibility_gap_path_summary": {"min": 0.8, "median": 0.9, "max": 1.0, "mean": 0.9},
                    "prompt_text": "Prompt high 2",
                    "answer_text": "Answer high 2",
                    "support_anchor_text": "",
                    "conflict_anchor_text": "",
                },
                {
                    "cycle_id": "triangle:103",
                    "edge_id_path": ["e7", "e8", "e9"],
                    "anchor_qualified_path": [False, True, True],
                    "relation_kind_path": ["residual_chord", "trusted_tree", "trusted_tree"],
                    "compatibility_gap_path_summary": {"min": 0.1, "median": 0.2, "max": 0.3, "mean": 0.2},
                    "prompt_text": "Prompt flat 1",
                    "answer_text": "Answer flat 1",
                    "support_anchor_text": "",
                    "conflict_anchor_text": "",
                },
                {
                    "cycle_id": "triangle:104",
                    "edge_id_path": ["e10", "e11", "e12"],
                    "anchor_qualified_path": [False, True, True],
                    "relation_kind_path": ["residual_chord", "trusted_tree", "trusted_tree"],
                    "compatibility_gap_path_summary": {"min": 0.2, "median": 0.3, "max": 0.4, "mean": 0.3},
                    "prompt_text": "Prompt flat 2",
                    "answer_text": "Answer flat 2",
                    "support_anchor_text": "",
                    "conflict_anchor_text": "",
                },
            ],
