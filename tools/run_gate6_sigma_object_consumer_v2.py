#!/usr/bin/env python3
"""Run a pure object-native Gate6 consumer with sqrt-gap spectral weighting."""
...
DEFAULT_TOKEN_CSV = "gate6h_token_telemetry.csv"
DEFAULT_SAMPLE_CSV = "gate6h_sample_summary.csv"
DEFAULT_AGGREGATE = "gate6h_aggregate_summary.md"

SCHEMA_VERSION = "gate6_native_sigma_object_consumer_artifacts_v2"
METHOD_ID = "gate6_native_object_consumer_sigma_sqrtgap_tailkeep_object_v2"
PRIMARY_METRIC_ID = "sigma_sqrtgap_tailkeep_object_v2"
PRIMARY_AUX_METRIC_ID = "sigma_gap_rel_v1"
PRIMARY_LEAKAGE_METRIC_ID = "sigma_tailkeep_rel_v1"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run a Gate6 object-native consumer from singular spectrum with sqrt-gap weighting."
    )
...
def compute_sigma_object_v2_metrics(
    gram_raw: np.ndarray,
    ...
    primary_value = float(math.sqrt(sigma_gap_rel) * sigma_tailkeep_rel)
    return {
        "loop_outcome": "none",
        BASELINE_METRIC_ID: score_f,
        PRIMARY_METRIC_ID: primary_value,
...
def build_token_rows(
    ...
    for step_row in step_rows:
        ...
        metrics = compute_sigma_object_v2_metrics(
...
def build_aggregate_summary(
    ...
    lines = [
        "# Gate6 Sigma Object Consumer Summary",
        "",
        f"run_id: {run_id}",
