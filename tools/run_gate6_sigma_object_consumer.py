#!/usr/bin/env python3
"""Run a pure object-native Gate6 consumer from singular spectrum only."""
...
DEFAULT_TOKEN_CSV = "gate6g_token_telemetry.csv"
DEFAULT_SAMPLE_CSV = "gate6g_sample_summary.csv"
DEFAULT_AGGREGATE = "gate6g_aggregate_summary.md"

SCHEMA_VERSION = "gate6_native_sigma_object_consumer_artifacts_v1"
METHOD_ID = "gate6_native_object_consumer_sigma_gap_tailkeep_object_v1"
PRIMARY_METRIC_ID = "sigma_gap_tailkeep_object_v1"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run a Gate6 object-native consumer from singular spectrum only."
    )
...
def compute_sigma_object_metrics(
    gram_raw: np.ndarray,
    ...
    return {
        "loop_outcome": "none",
        BASELINE_METRIC_ID: score_f,
        PRIMARY_METRIC_ID: float(sigma_gap_rel * sigma_tailkeep_rel),
...
def build_token_rows(
    ...
    for step_row in step_rows:
        ...
        metrics = compute_sigma_object_metrics(
