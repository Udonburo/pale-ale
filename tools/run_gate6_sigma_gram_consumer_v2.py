#!/usr/bin/env python3
"""Run a Gate6 sigma/gram consumer with tail-aware spectral-gap weighting."""
...
DEFAULT_TOKEN_CSV = "gate6f_token_telemetry.csv"
DEFAULT_SAMPLE_CSV = "gate6f_sample_summary.csv"
DEFAULT_AGGREGATE = "gate6f_aggregate_summary.md"

SCHEMA_VERSION = "gate6_native_sigma_gram_consumer_artifacts_v2"
METHOD_ID = "gate6_native_object_consumer_sigma_gap_tailkeep_v2"
PRIMARY_METRIC_ID = "sigma_gap_tailkeep_weighted_gram_loop_v2"
PRIMARY_AUX_METRIC_ID = "sigma_gap_tailkeep_rel_v2"
PRIMARY_LEAKAGE_METRIC_ID = "sigma_tailkeep_rel_v2"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "using tail-aware spectral-gap weighting."
        )
    )
...
def compute_sigma_gap_tailkeep_metrics(
    gram_raw: np.ndarray,
    ...
    if sigma_gap_rel is None or sigma_2_rel is None or sigma_3_rel is None:
        return {
            ...
            "sigma_gap_rel_v1": None,
        }
    sigma_tailkeep_rel = max(0.0, 1.0 - sigma_3_rel)
    sigma_gap_tailkeep_rel = float(sigma_gap_rel * sigma_tailkeep_rel)
    return {
        "loop_outcome": "none",
        BASELINE_METRIC_ID: score_f,
        PRIMARY_METRIC_ID: float(score_f * sigma_gap_tailkeep_rel),
        PRIMARY_AUX_METRIC_ID: sigma_gap_tailkeep_rel,
        PRIMARY_LEAKAGE_METRIC_ID: sigma_tailkeep_rel,
        "sigma_gap_rel_v1": sigma_gap_rel,
    }
...
def build_token_rows(
    ...
    for step_row in step_rows:
        ...
        metrics = compute_sigma_gap_tailkeep_metrics(
        ...
        token_rows.append(
            {
                ...
                "sigma_gap_rel_v1": metrics["sigma_gap_rel_v1"],
