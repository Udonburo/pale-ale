% Prepublication manuscript source.
...
\small DOI: \href{https://doi.org/10.5281/zenodo.22180751}{10.5281/zenodo.22180751}\\[-1pt]
...
\item \textbf{One task surface.} The frozen natural-language-rule surface and its opaque codebooks do not establish task-general state use.
...
The version-specific Zenodo DOI \href{https://doi.org/10.5281/zenodo.22180751}{10.5281/zenodo.22180751} is the primary archival reference for this report and its reproducibility capsule. The public \href{https://github.com/Udonburo/pale-ale}{GitHub repository} remains the development and browsing surface. The execution record is fixed by the full commit permalink \href{https://github.com/Udonburo/pale-ale/commit/407d20fd4f074b9ef4524c82c8136874efaec476}{\hash{407d20fd4f074b9ef4524c82c8136874efaec476}}. The Zenodo release contains a model-forward-free reproducibility capsule, exact model and runtime identities, the 20-block and 60 layer-block qualification records, deterministic Figure~\ref{fig:main} and Table~\ref{tab:gate-decomposition} inputs, licenses, and top-level \code{CHECKSUMS-SHA256.txt}. The continuous Stage M fields are exposed in \code{stage_m_layer_block_records.csv} and a matching JSON record, both derived by a source-hash-locked model-free exporter. No additional model execution or activation extraction was performed during manuscript assembly, and no inferential outcome analysis was opened.
...
Stage M result & \hash{8c56c308856d486b77356a42fe54ef0bea8f91e486dc5dd3820c3a60db5be772} \\
